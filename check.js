...
// Checks all tracked products and sends Telegram alerts for stock changes
...
async function main() {
  ...
  if (products.length === 0) {
    console.log('No products tracked. Add products to data/products.json');
    return;
  }
